...
<body>
    <div id="login-button">
        <img
            src="https://cdn3.iconfinder.com/data/icons/mother-earth-day-6/64/Earth_hour-ecology-environment-turn_off-switch-world-512.png">
    </div>
    <div id="container">
        <h2 style="text-align: center;color:white;">Iniciar sesión</h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            @enderror
            <input type="submit" class="btn btn-primary" value="Entrar" style="background-color: #5DADE2 ;">
